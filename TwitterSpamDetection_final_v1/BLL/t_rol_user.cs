...
namespace TwitterSpamDetection.BLL
{
	...
	{
		private readonly DAL.t_rol_user dal=new DAL.t_rol_user();
		public t_rol_user()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.t_rol_user GetModelByCache(string ID)
		{
			
			string CacheKey = "t_rol_userModel-" + ID;
			...
			return (Model.t_rol_user)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.t_rol_user> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.t_rol_user> DataTableToList(DataTable dt)
		{
			List<Model.t_rol_user> modelList = new List<Model.t_rol_user>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.t_rol_user model;
        ...
        {
            return dal.checkUserExistance(userName);
        }
